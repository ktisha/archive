...
public class State extends BaseConcept implements INamedConcept {
  public static final String concept = "tuzova.finiteStateMachine.structure.State";
  ...
  public static State newInstance(SModel sm, boolean init) {
    return (State)SModelUtil_new.instantiateConceptDeclaration("tuzova.finiteStateMachine.structure.State", sm, GlobalScope.getInstance(), init).getAdapter();
  }
